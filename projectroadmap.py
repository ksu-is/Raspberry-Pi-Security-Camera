#This is a list of steps for operating the raspberry pi security camera.
- [X] Gather raspberry pi 3b, motion sensor, and camera.
...
- [ ] Import the secure login code to the initial security code.
- [ ] Develop a website that can hold each piece of footage captured.
